...
Router::group(['param' => ['session', '!empty', 'user_id']], function(){
    ...
    Router::any("paypal", ["as" => "user.settings.post", "uses" => "UserController@paypalPost"]);
    Router::any("donation", ["as" => "user.settings.post", "uses" => "UserController@donationPost"]);
    Router::any("update", ["as" => "user.settings.post", "uses" => "UserController@updatePost"]);
    Router::any("discord", ["as" => "user.settings.post", "uses" => "UserController@discordPost"]);
