...
<html lang="ru">
  <head>
    ...
    <title>StreamDonate | Подтверждение аккаунта</title>
  ...
  <body>
    ...
    <div class="container">
        <div class="page-header">
            <h1>StreamDonate | Подтверждение аккаунта</h1>
        </div>
        <div class="panel panel-default">
            <div class="panel-body">
				Вы запросили на подтверждение почтового ящика, перейдите по ссылку                 
				<br><br>
