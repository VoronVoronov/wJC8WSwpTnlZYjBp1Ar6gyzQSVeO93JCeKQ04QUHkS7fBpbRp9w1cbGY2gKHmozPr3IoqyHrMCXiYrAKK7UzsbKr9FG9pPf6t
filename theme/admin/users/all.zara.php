...
<table class="money_back">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> <a href="http://donatify.ru/{{ $user['user_domain'] }}/">Клик</a></td>
            ...
            <td><a href="http://donatify.ru/admin/users/{{ $user['user_id'] }}"><i class="fa fa-edit okRequest" data-toggle="tooltip" data-placement="top" title="Редактировать"></i></a></td>
