        ...
        <div class="user-right">
            <table>
                <tr>
                    ...
                    <td class="profile-change @if(empty($wallets->qiwi)) empty @endif" data-type="qiwi" data-toggle="tooltip" data-placement="top" title="Для изменения кликните дважды">{{ $user['user_wallets']->qiwi or "Не указано" }}</td>
                </tr>
                <tr>
                    <td>WebMoney</td>
                    ...
                    <td class="profile-change @if(empty($wallets->webmoney)) empty @endif" data-type="webmoney" data-toggle="tooltip" data-placement="top" title="Для изменения кликните дважды">{{ $user['user_wallets']->webmoney or "Не указано" }}</td>
                </tr>
                <tr>
                    <td>Яндекс Деньги</td>
                    ...
                    <td class="profile-change @if(empty($wallets->yamoney)) empty @endif" data-type="yamoney" data-toggle="tooltip" data-placement="top" title="Для изменения кликните дважды">{{ $user['user_wallets']->yamoney or "Не указано" }}</td>
                </tr>
                <tr>
                    ...
                    <td class="profile-change @if(empty($wallets->bank)) empty @endif" data-type="bank" data-toggle="tooltip" data-placement="top" title="Для изменения кликните дважды">{{ $user['user_wallets']->bank or "Не указано" }}</td>
                </tr>
            </table>
        </div>
